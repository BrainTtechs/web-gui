...
const DataChart = ({ data }) => {
  ...
  const style = styler([
    { key: 'p1_740', color: '#d32f2f' },
    { key: 'p2_740', color: '#1976d2' },
    { key: 'p3_740', color: 'green' },
    { key: 'p4_740', color: '#9c27b0' },
    { key: 'p1_850', color: '#ed6c02' },
    { key: 'p2_850', color: '#0288d1' },
    { key: 'p3_850', color: '#2e7d32' },
    { key: 'p4_850', color: 'steelblue' }
  ]);
